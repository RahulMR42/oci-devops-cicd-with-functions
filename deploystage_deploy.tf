resource "oci_devops_deploy_stage" "test_deploy_stage" {
  ...
  description  = "${var.app_name}_${random_string.deploy_id.result}_devops_deploy_stage_with_default_image"
  display_name = "${var.app_name}_${random_string.deploy_id.result}_devops_deploy_stage_with_default_image"
